...
| File | Contents |
|---|---|
| `source_en.txt` | English source sentences |
| `reference_de.txt` | Professional human translation into German |
| `system_1_de.txt` | Output from a leading commercial NMT engine |
| `system_2_de.txt` | Output from a local NMT engine |
| `system_3_de.txt` | Output from an open-weight LLM (large) |
| `system_4_de.txt` | Output from an open-weight LLM (medium / small) |
